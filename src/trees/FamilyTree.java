...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("invalid input, index doesn't exist");
		...
		else
		{
			...
			if(parentNode.getName() == null) {
				throw new TreeException("error with data file");
			}
